...
$graph->SetScale('datlin',min(array_merge($ydata, array(49)))-10,max(array_merge($ydata, array(49))) + 10, min($xdata),max($xdata));
...
// Create the marker plot - a score of 49 is the target to aim for
...
$lineplot->SetLegend('Your recorded health score');
$markerplot->SetLegend('Target of a health score of 49 each week');
