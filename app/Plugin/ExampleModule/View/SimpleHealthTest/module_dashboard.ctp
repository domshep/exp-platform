...
<div class="modules">
	<div class="module">
		...
		<h4 class="graph-caption">Your &lsquo;simple&rsquo; health scores over recent weeks</h4>
		<p><?php 
				echo $this->Html->image(
					'/example_module/simple_health_test/minigraph', 
					array(
						'alt' => 'Your &lsquo;simple&rsquo; health scores over recent weeks',
		...
		<p><?php echo $this->Html->link(__('View your monthly records'), array('action' => 'view_records'),array('class' => 'button')); ?></p>
	</div>
	<div class="module">
