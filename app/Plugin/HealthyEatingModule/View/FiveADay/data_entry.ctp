...
<div class="users form">
	<h3><?php echo __('Week 1: ') . gmdate("d/m/Y"); ?></h3>
	...
	<table cellspacing="0" id="fiveadayweekly">
		...
		<tr>
			...
			<td><?php 
				...
				$dayoftheweek = gmdate('w');
				$dayssincemonday = 6-$dayoftheweek; // how many days is it since Monday?
				$weekstartdate = gmmktime(0,0,0,gmdate("m"),gmdate("d")-$dayssincemonday,gmdate("Y"));
