...
<p><?php echo $this->Html->link(__('Add weekly record'), array('action' => 'data_entry')); ?></p>
<div class="modules">
	<div class="module" style="text-align:center;">
		...
		<p><?php echo $this->Html->link(__('View My Records'), array('action' => 'view_records')); ?></p>
</div>
	<div class="module">
		...
		<p><?php echo $this->Html->link(__('View My Weekly Stats'), array('action' => 'view_records')); ?></p>
	</div>
	<div class="module">
