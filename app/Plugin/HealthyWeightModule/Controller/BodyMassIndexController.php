...
class BodyMassIndexController extends HealthyWeightModuleAppController implements ModulePlugin {
	...
	public function admin_edit($id=null) {
		...
		{
			//$options = array('conditions' => array('BmiModule.BmiWeekly.id' => $id));
			//$this->request->data = $this->BmiWeekly->id = $id;//'first', $options);
    		$this->set('BmiWeekly', $this->BmiWeekly->id = $id);
		}	
  	}*/
