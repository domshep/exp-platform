<?php 
	/* The module dashboard is not used by this module 
	$this->extend('/Modules/module_template');
	echo $this->Html->css('/Motivation/css/module.css');
?>
...
<div class="modules">
	<div class="module">
		...
		<p><?php 
				echo $this->Html->image(
					'/motivationmodule/motivation/minigraph', 
...
<p>Sorry, This module does not have a module dashboard.</p>
