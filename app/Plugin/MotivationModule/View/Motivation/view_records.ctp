...
echo $this->Html->css('/MotivationModule/css/module.css');
?>
<h2>Your monthly records</h2>
<p>Use this screen to quickly review your records on a month-by-month basis.
<div class="calendar-holder">
<?php 
	echo $this->Calendar->calendar($year,$month,$records, $popups,'/motivation_module/motivation/view_records','/motivation_module/motivation/data_entry','7','green-simple','red-simple'); 
?>
</div>
