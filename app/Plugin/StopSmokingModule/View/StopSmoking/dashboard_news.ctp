<?php
	$medal = "";
	$consecWeeks = $achievements['StopSmokingAchievement']['consec_healthy_weeks'];
	if ($consecWeeks >= 6){ 
		$medal = "Gold";
		$weekstogo = 0;
		$nextmedal = "";
	...
	if ($medal != "")
	{
		...
		echo "You have achieved Your " . $medal . " Medal by being smoke free for " . $consecWeeks;
		echo " week". $s . ".</p>"; 
	}
	else echo "<p>So far you have been smoke free for ". $consecWeeks . " week". $s .".</p>";
