...
<?php 
if($score < 2) { ?>
	<p class="lead">This indicates you have a very low dependence on nicotine</p>
<?php } elseif ($score < 8) { ?>
	<p class="lead">This indicates you have a medium dependence on nicotine</p>
<?php } else {?>
	<p class="lead">This indicates you have a very high dependence on nicotine</p>
<?php }
...
<?php
$options = array(
		'label' => 'Add the &lsquo;Stop Smoking&rsquo; module to my dashboard',
		'escape' => false,
