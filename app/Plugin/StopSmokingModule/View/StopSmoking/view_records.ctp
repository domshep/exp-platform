...
<?php echo $this->Html->image('/stop_smoking_module/img/smiley-face.png', array('alt' => "Smiley face icon", 'escape' => false, 'class'=> 'small-icon', 'style'=>'vertical-align:middle;float:left;clear:both;'));?>
...
<?php echo $this->Html->image('/stop_smoking_module/img/smoking-face.png', array('alt' => "Smoking face icon", 'escape' => false, 'class'=> 'small-icon', 'style'=>'vertical-align:middle;float:left;clear:both'));?>
