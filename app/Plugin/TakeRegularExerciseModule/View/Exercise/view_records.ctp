...
<?php 
	echo $this->Calendar->calendar($year,$month,$records,'/take_regular_exercise_module/exercise/view_records','/take_regular_exercise_module/exercise/data_entry','21','green-exercise','red-exercise'); 
?>
</div>
...
<?php echo $this->Html->image('/take_regular_exercise_module/img/Emotes-face-smile-big-icon.png', array('alt' => "Smiley face icon", 'escape' => false, 'class'=> 'small-icon', 'style'=>'vertical-align:middle;float:left;clear:both;'));?>
