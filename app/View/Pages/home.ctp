<div>
	...
	<p><strong>Please note that this version continues to be an 'alpha' release. Although a lot of the functionality is now in place for the "expected user journey", you will experience bugs and problems if you travel too far from the beaten track... This release is intended primarily for early feedback on the website, and any data you record may be deleted by future releases.</strong>
