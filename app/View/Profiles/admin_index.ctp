<div class="profiles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('height_cm'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($profile['Profile']['height_cm']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['post_code']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['mobile_no']); ?>&nbsp;</td>
